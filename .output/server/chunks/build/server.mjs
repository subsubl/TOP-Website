...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext, Text } from 'vue';
import { w as hasProtocol, x as isScriptProtocol, y as joinURL, z as withQuery, A as sanitizeStatusCode, B as getContext, C as parsePath, D as parseQuery, $ as $fetch$1, E as baseURL, F as createHooks, G as executeAsync, q as createError$1, H as toRouteMatcher, I as createRouter$1, J as defu, K as getRequestURL, L as getCookie, M as getRequestHeader, d as destr, N as klona, O as createDefu, P as isEqual, Q as withoutTrailingSlash, R as setCookie, S as deleteCookie, T as isEqual$1 } from '../_/nitro.mjs';
...
const __nuxt_page_meta = {
  title: "TOP - Paddle & Tennis School",
  description: "The premier destination for paddle and tennis instruction."
};
const _routes = [
  {
    name: "index___en",
    ...
    component: () => import('./index-CB-B3dD7.mjs')
  },
  {
    name: "index___es",
    path: "/es",
  ...
  },
  {
    name: "prices___en",
    path: "/prices",
    component: () => import('./prices-Bx_P1PFv.mjs')
  },
  {
    name: "prices___es",
    path: "/es/prices",
  ...
  },
  {
    name: "booking___en",
    path: "/booking",
    component: () => import('./booking-C3wPFNlc.mjs')
  },
  {
    name: "booking___es",
    path: "/es/booking",
  ...
  },
  {
    name: "classes___en",
    path: "/classes",
    component: () => import('./classes-DSuOWkpG.mjs')
  },
  {
    name: "classes___es",
    path: "/es/classes",
  ...
  },
  {
    ...
    path: "/references",
    component: () => import('./references-BtlSrT9t.mjs')
  },
  {
    name: "references___es",
    path: "/es/references",
    component: () => import('./references-BtlSrT9t.mjs')
  }
];
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/vyRC5fbY"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/vyRC5fbY"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CK8Hes5z.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DmgyN6C1.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-COpRZOLH.mjs'));
...
export { _export_sfc as _, useLocalePath as a, useSwitchLocalePath as b, useRouter as c, useNuxtApp as d, entry_default as default, useRuntimeConfig as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, useHead as u };
